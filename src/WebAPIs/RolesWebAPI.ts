...
type RolesWebAPIMethods = "/api/roles-get" | "/api/roles-queryrolesofuser" | "/api/roles-queryrolesofuserindomain/" 
type RolesAdminWebAPIMethods = "/api/roles-add" | "/api/roles-delete" | "/api/roles-update" 

export const RolesWebAPI ={
    Get:async() => (await WebAPI.get(<RolesWebAPIMethods>"/api/roles-get")).data as Role[],
